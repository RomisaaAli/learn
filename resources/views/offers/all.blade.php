...
<body>
    ...
    <table class="table">
        <thead>
          <tr>
            <th scope="col"></th>
            <th scope="col">{{__('masseges.Offer Name')}}</th>
            <th scope="col">{{__('masseges.Offer price')}}</th>
            <th scope="col">{{__('masseges.operation')}}</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
           ...
           <a href="{{url('offers/edit/'.$offer ->id)}}"
             class="btn btn-success">{{__('masseges.update')}}</a></td>
          </tr>
          @endforeach
        </tbody>
      </table>
